...
const Footer = () => {
    return (
        <div className={isMobile === true ? 'Mobile footer fade-in': 'footer fade-in'}>
            <div className={isMobile === true ? 'Mobile kaywonLogoWrap' : 'kaywonLogoWrap'}>
                <img alt='kaywonLogo' className='kaywonLogo fade-in' src={kaywonLogo} />
