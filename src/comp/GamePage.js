    ...
    return (
        <div className="gamePages">
            <div className="gameList">
                {/* 졸전 리스트 */}
                <div className="gamePTitle Gamelist">GAME LIST</div>
                {GAME_DATA.map((game) => (
            ...
            <div className={GAME_DATA[Id].classN + ' fade-in'}>
                ...
                <div className="gamePTitle gamePageT">
                    ...
                    <div className="gamPsubT gamePageT">
                        {GAME_DATA[Id].platform}&nbsp;&nbsp;
                        <h3>{GAME_DATA[Id].team}</h3>
                    </div>
                </div>
                {/* game Intro */}
                ...
                <div className="gamePTitle">
                    <div className="gamPmainT gamePage">플레이</div>
                    <div className="gamPsubT">Play</div>
                </div>
                <div className="youTubeWrap">
                    <YouTube
                        className="youTube"
                        videoId={GAME_DATA[Id].videoId}
                        opts={youtubeStngs}
                    />
                </div>
                {/* 스크린샷 */}
                <div className="gamePTitle">
                    <div className="gamPmainT gamePage">그래픽</div>
                    <div className="gamPsubT">Graphic</div>
                </div>
                <div className="grad-wrapper">
                    <Slider {...sliderStngs}>
                        ...
                        <div className="grad-img illust">
                            <img
                                alt="grad-illust1"
                                src={GAME_DATA[Id].illust_01}
                            />
                        </div>
                        <div className="grad-img illust">
                            <img
                                alt="grad-illust2"
                                src={GAME_DATA[Id].illust_02}
                            />
                        </div>
                    </Slider>
                </div>
                ...
                <div className="gamePTitle">
                    <div className="gamPmainT">개발진</div>
                    <div className="gamPsubT">Developers</div>
                </div>
                <div className="developer">
                    {developers.map((member) => (
                        <div
                            key={Object.keys(member)[0] + '02'}
                            className="dev-wraper"
                        >
                ...
                {GAME_DATA[Id].classN === 'ArtBusters' ? (
                    <div className="copyRight">
                        <div className="gamePTitle">
                            <div className="gamPmainT">저작권 표기</div>
                            <div className="gamPsubT">Copyright</div>
                        </div>
                        <div className="copyRightDetail">
                            <h3>
                                <b>BGM 출처</b>
                            </h3>
                            <b>스토리 컷씬</b>: 구재영,계한용_Pradeof children
                            <br />
                            <b>자료출처</b>: https://gongu.copyright.or.kr
                            <br />
                            <b>Music promoted by DayDreamSound</b>:
                            https://youtu.be/NZvS-MRSSug
                            <br />
                            <h3>
                                <b>타이틀</b>
                            </h3>
                            KMu$ic - Welsh Corgi
                            <br />
                            <b>Music by Kmu$ic</b>: http://bit.ly/Kmusic_Youtube
                            <br />
                            <b>Download Video Link</b>:
